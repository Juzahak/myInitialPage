...
$(document).ready(function () {
  ...
  var sidebar = $(".sidebar")
  if (sidebar.length != 0) {
    $(".sidebar .nav > .has-sub").click(function () {
  ...
  $("body").on("change", ".ec-image-upload", function (e) {
    ...
    if (this.files && this.files[0]) {
        ...
        reader.onload = function (e) {
            ...
            var ec_image_preview = lkthislk.parent().parent().children('.ec-preview').find('.image-upload').attr('src', e.target.result);
            
            // var ec_image_preview = lkthislk.parent().parent().children(".ec-preview").find(".cropper-hidden")[0].setAttribute("src", e.target.result);

            // console.log(ec_image_preview);
  ...
  $('.fa-span').click(function() {
      ...
      $('#fa-preview').html('<code>&lt;i className=&quot;'+ fa_class +'&quot;&gt;&lt;/i&gt;</code>');
